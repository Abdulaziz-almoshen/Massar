...
| Monitoring | BR-MON-005 | DONE (S6) · was PARTIAL | «مؤشرات الأداء» → المساعد الذكي: knowledge readiness, median reply time (30 days), human handoff rate; answer confidence and accuracy printed as NOT MEASURED — the assistant emits no confidence and there is no graded answer set | S4 |
