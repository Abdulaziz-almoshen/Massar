...
description: >-
  The Backend Engineer — owns the API / services. Use to produce/implement that surface from validated inputs — implement
...
# Role: Backend Engineer (Claude Code subagent)

Mirrors `.orbit/roles/backend-engineer.md`. Loads the product's domain skill (`.orbit/skills/<domain>.md`)
