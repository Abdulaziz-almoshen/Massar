...
Oracle: `.orbit/artifacts/campaigns-crm/requirements.md` (AC-1..AC-14) + `plan.md`.
Evidence root: `.orbit/qa/campaigns-crm/rtm-evidence/` · raw assertions `rtm-evidence/probe-results.json`.
